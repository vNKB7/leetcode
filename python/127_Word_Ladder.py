...
#         queue = [beginWord]
#         turns = 1
#         while turns < len(wordList)+2:
#             turns += 1
#             newQueue = []
#             while len(queue) > 0:
#                 beginWord = queue.pop()
#                 if self.shiftOne(beginWord, endWord):
#                     return turns
#
#                 remainList = []
#                 for word in wordList:
#                     if self.shiftOne(beginWord, word):
